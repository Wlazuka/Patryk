...
public class Utils {
    ...
    public static List<Lekarz> getListOfDoctors(String filePath) throws FileNotFoundException{
    ...
    public static List<Wizyta> createListOfVisits(String filePath, List<Lekarz> lekarze, List<Pacjent> pacjenci) throws FileNotFoundException{
        Scanner input = new Scanner(new File(filePath));
        input.useDelimiter("\t|\r\r|\n\n\n");
    ...
    public static List<Pacjent> getListOfPatients(String filePath) throws FileNotFoundException {
        Scanner input = new Scanner(new File(filePath));
        input.useDelimiter("\t|\r\r");
