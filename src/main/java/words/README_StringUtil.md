...
Please, implement [`StringUtil`](src/main/java/words/StringUtil.java) class methods:
...
### Examples
You may use `main` method of [`StringUtil`](src/main/java/words/StringUtil.java)
